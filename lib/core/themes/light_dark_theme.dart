...
ThemeData lightThemeData() {
  return ThemeData.light().copyWith(
    ...
    textTheme: TextTheme(
      displaySmall:
          AppTextStyles.robotoMono10.copyWith(color: AppColors.lightPrimary),
      labelSmall:
          AppTextStyles.merriweather8.copyWith(color: AppColors.lightPrimary),
      bodyLarge:
      ...
      titleLarge:
          AppTextStyles.merriweatherBold20.copyWith(color: AppColors.lightPrimary),
    ),
...
ThemeData darkThemeData() {
  return ThemeData.dark().copyWith(
    ...
    textTheme: TextTheme(
      displaySmall:
          AppTextStyles.robotoMono10.copyWith(color: Colors.white),
      labelSmall:
          AppTextStyles.merriweather8.copyWith(color: Colors.white),
      bodyLarge:
          AppTextStyles.merriweather14.copyWith(color: Colors.white),
      bodyMedium:
          AppTextStyles.merriweather12.copyWith(color: Colors.white),
      bodySmall:
          AppTextStyles.merriweather10.copyWith(color: Colors.white),
      titleLarge:
          AppTextStyles.merriweatherBold20.copyWith(color: Colors.white),
    ),
